...
from department.app import app, db
...
def make_shell_context():
    ...
    from department.app import Department, Course, Subject
...
def fixtures():
    ...
    import csv
    from department.app import Department, Course, CourseType, Subject, SubjectPeriod
